        ...
        <div className="musicsectionbackground mt-[40px] sm:mt-[60px] md:mt-[80px] lg:mt-[100px] xl:mt-[120px] 2xl:mt-[142px] relative">
            ...
            <div className="text-center md:text-left">
                ...
                <div className="">
                    ...
                    <p className='text-[#ffffff80] manrope text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px] font-normal leading-[180%] mt-[15px] sm:mt-[17px] md:mt-[22px] lg:mt-[25px] xl:mt-[28px] 2xl:mt-[33px] mx-9 sm:px-0'>
                ...
                <div className="flex flex-col">
                    ...
                    <a className="text-[#ffffff80] manrope text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px] font-normal leading-[120%] "
                    >120+ Video Avatars</a>
                    </p>
                    <p className="mb-[14px] sm:mb-[16px] md:mb-[18px] lg:mb-[20px] xl:mb-[22px] 2xl:mb-[24px]">
                    <a className="text-[#ffffff80] manrope text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px] font-normal leading-[120%]"
            ...
            <div className="py-[14px] sm:py-[20px] md:py-[25px] lg:py-[30px] xl:py-[35px] 2xl:py-[40px] flex justify-between items-center flex-col gap-4 sm:gap-0 sm:flex-row mt-5 sm:mt-0">
                ...
                <div className="flex items-center gap-10">
                    <a href="" className='text-[#ffffff80] manrope text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px] font-normal leading-[120%]'>Privacy Policy</a>
                    <a href="" className='text-[#ffffff80] manrope text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px] font-normal leading-[120%]'>Terms of Use</a>
                </div>
            </div>
            </div>
        </div>
